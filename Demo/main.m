...
% Last Modified by GUIDE v2.5 06-Apr-2019 19:06:18
...
theImage = imread('model.png');
  axes(handles.axes80); % Use actual variable names from your program!
  imshow(theImage);
...
%optitrack('data\test',handles.axes57,handles.axes59);
ground36plot(handles.axes59);   
...
global JntRslt;
 %tab=handles.uitable10;
  ...
  selected=[100 200 300 400 500 600 700 800 900 1000 1100 1200 1300 1400 1500 1600 2000 2100 2200 2300 2400 2500 3000 4000];    
  
 for jh=selected
 axes(handles.axes61);
 [Globalu ,Localu ,angleu]=testshow('Discussion',15,'data\test Discussion',handles.axes57,handles.axes61,jh);
 axes(handles.axes78);
 ground36plot(handles.axes78,jh); 
