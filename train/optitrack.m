function f = optitrack(fold,ax1,ax2) 
...
for ff = 8109:length(time) %#ok<FORPF>
 ...
 view(3);
  ...
  for nn = 1:17
        ...
        plot3(ax2,skeleton(c).Dxyz(1,ff),skeleton(c).Dxyz(3,ff),skeleton(c).Dxyz(2,ff),'.','markersize',40,'Color','black');
